                ...
                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2  row-cols-xl-2 row-cols-xxl-2 g-2">
                 ...
                 <div>
                   <div className="col"  id={value.ticketid}   key={value.ticketid}>
                            ...
                            {/* <TicketDownload ticketnumber={value.ticketid} announcementdate={value.announcement_date} 
                            validitydate={value.end_date} offername={value.offer_name} Frame={`http://billy247.com:3002/offer/${value.offer_url}`}/> */}
...
{          detail!=null?
            <Modal show={show} onHide={handleClose} backdrop="static"
                ...
                <div className='rounded border-primary m-1'>
                    ...
                    {/* <TicketDownload ticketnumber={detail.ticketid} announcementdate={detail.announcement_date} Frame={`http://billy247.com:3002/offer/${detail.offer_url}`} validitydate={detail.end_date} offername={detail.offer_name}/> */}
