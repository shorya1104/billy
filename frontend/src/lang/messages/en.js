const enMessages = {
  ...
  'menu.add_blog': 'Add Blog',
  'menu.addnewblog': 'Add New Blog',
  'menu.edit_blog': 'Edit Blog',
  'menu.blog': 'Blog',
  'menu.ticketoffer': 'Offer',
  'menu.createoffer': 'Create Offer',
  'menu.offerlist': 'Offer List',
  'menu.tikcets': 'Ticket',
  'menu.tikcetgenerator': 'Ticket Generator',
  'menu.ticketlist': 'Ticket List',
  ' menu.offercard':'Offer Card',
  'menu.editoffer': 'Edit Offer',
  'menu.blog_details': 'Blog Details',
  'menu.ticket_register': 'Ticket Generator',
  'menu.ticketdetails': '',
  'menu.ticketdownload': 'Ticket Download',    
